...
public class BreakoutBasic extends GraphicsProgram {
	...
	private static final int BALL_Y_VELOCITY = 6;
	...
	/** Bounces off the paddle while preventing a bug where the paddle sticks into the ball */
	...
	/** Track if the collision was with the side of the ball */
